 ...
 * compra. Mapea la tabla 'entradas_asignadas'.
 */
@Entity
...
public class EntradaAsignada implements Serializable {
    ...
    @NotNull(message = "El estado de la entrada asignada no puede ser nulo.")
     ...
     */
    @NotNull(message = "La entrada asignada debe provenir de un detalle de compra.")
